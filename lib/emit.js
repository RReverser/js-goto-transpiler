...
function Emitter(contextId) {
  ...
  Object.defineProperties(this, {
    ...
    // A list of label locations
    labelLocs: { value: Object.create(null) }
  });
...
Ep.explodeStatement = function(path, labelId) {
  ...
  case "LabeledStatement":
    ...
    if (stmt.label.name === "goto") {
      ...
      var name = expr.name;
      self.jump(this.labelLocs[name] || (this.labelLocs[name] = loc()));
      break;
    }

    var name = stmt.label.name;
    var before = this.labelLocs[name] || (this.labelLocs[name] = loc());
    var after = loc();
